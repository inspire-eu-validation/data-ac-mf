# Data Specification on Atmospheric Conditions and Meteorological Geographical Features
                       
The Data Specification on Atmospheric Conditions and Meteorological Geographical Features – Technical Guidelines (version 3.0) and the associated GML application schema specifying requirements for the interoperability of spatial data sets of the data theme Atmospheric Conditions and Meteorological Geographical Features.

The specification specifies the following conformance classes:

| Conformance class | Standardization target |
| ----------------- | ---------------------- |
| [GML application schemas, Atmospheric Conditions and Meteorological Geographical Features](http://inspire.ec.europa.eu/id/ats/data-ac-mf/3.0/ac-mf-gml) | INSPIRE spatial data set encoded in GML, Atmospheric Conditions and Meteorological Geographical Features features |
| [Application Schema, Atmospheric Conditions and Meteorological Geographical Features](http://inspire.ec.europa.eu/id/ats/data-ac-mf/3.0/ac-mf-as) | INSPIRE spatial data set |
| [Reference Systems, Atmospheric Conditions and Meteorological Geographical Features](http://inspire.ec.europa.eu/id/ats/data-ac-mf/3.0/ac-mf-rs) | INSPIRE spatial data set |
| [Data Consistency, Atmospheric Conditions and Meteorological Geographical Features](http://inspire.ec.europa.eu/id/ats/data-ac-mf/3.0/ac-mf-dc) | INSPIRE spatial data set |
| [Information Accessibility, Atmospheric Conditions and Meteorological Geographical Features](http://inspire.ec.europa.eu/id/ats/data-ac-mf/3.0/ac-mf-ia) | INSPIRE spatial data set |
| [Portrayal, Atmospheric Conditions and Meteorological Geographical Features](http://inspire.ec.europa.eu/id/ats/data-ac-mf/3.0/ac-mf-portrayal) | INSPIRE view service |
...
5. The IR conformance classes for application schemas without non-abstract feature types, e.g. "Atmospheric Conditions and Meteorological Geographical Features - Core", are not needed as no feature instance can be of a type from that application schema.
